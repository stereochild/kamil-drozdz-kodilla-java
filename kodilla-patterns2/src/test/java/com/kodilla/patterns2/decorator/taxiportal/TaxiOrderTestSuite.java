package com.kodilla.patterns2.fascade.decorator.taxiportal;
...
public class TaxiOrderTestSuite {
    ...
    public void testUberWithTwoChildSeatsGetCost() {
        //Given
        TaxiOrder theOrder = new BasicTaxiOrder();
        theOrder = new UberNetworkOrderdDecorator(theOrder);
        theOrder = new ChildSeatDecorator(theOrder);
        theOrder = new ChildSeatDecorator(theOrder);
        //When
        BigDecimal theCost = theOrder.getCost();
    ...
    @Test
    public void testUberWithThwChildSeatsGetDescription() {
        //Given
        TaxiOrder theOrder = new BasicTaxiOrder();
        theOrder = new UberNetworkOrderdDecorator(theOrder);
        theOrder = new ChildSeatDecorator(theOrder);
